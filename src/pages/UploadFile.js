...
class UploadFile extends Component {
	...
	handleUploadPet(e){
		...
		axios({
			url: `https://52.3.6.109:8443/app/relatorios/anexo-pet`,
			method: "POST",
			headers:{
	...
	handleUploadUser(e){
		...
		axios({
			url: `https://52.3.6.109:8443/app/relatorios/anexo-usuarios`,
			method: "POST",
			headers:{
				authorization: `your token`
			},
	...
	handleUploadUserPet(e){
		...
		axios({
			url: `https://52.3.6.109:8443/app/relatorios/anexo-usuarios-pets`,
			method: "POST",
			headers:{
				authorization: `your token`
			},
